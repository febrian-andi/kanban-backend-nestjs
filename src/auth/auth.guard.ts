...
import { SKIP_AUTH_GUARD } from 'src/core/decorators/skip-auth.decorator';
import { AuthRequest } from 'src/core/request/auth';
...
export class AuthGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    const isSkipAuthGuard = this.reflector.getAllAndOverride<boolean>(
      SKIP_AUTH_GUARD,
